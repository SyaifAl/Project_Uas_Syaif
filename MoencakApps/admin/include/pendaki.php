    ...
    <section class="content">
              ...
              <table class="table table-bordered">
                    ...
                    <?php 
                      ...
                      $sql_k = "SELECT `id_pendaki`,`nama_pendaki`, `nik`, `jenis_kelamin`, `email`, `telpon`, `id_booking` FROM `pendaki`  ";
                      if (isset($katakunci_pendaki) && !empty($katakunci_pendaki)){
                          $sql_k .= " WHERE `nama_pendaki` LIKE '%$katakunci_pendaki%' ";
                      } 
                      $sql_k .= " ORDER BY `nama_pendaki` limit $posisi, $batas";
              ...
              <!-- /.card-body -->
              <?php
              $sql_jum = "SELECT `id_pendaki`,`nama_pendaki`, `nik`, `email`, `telpon`, `id_booking` FROM `pendaki`  ";
                  if (isset($katakunci_pendaki) && !empty($katakunci_pendaki)){
                      $sql_jum .= " WHERE `nama_pendaki` LIKE '%$katakunci_pendaki%' ";
                  } 
                  $sql_jum .= " ORDER BY `nama_pendaki` ";
