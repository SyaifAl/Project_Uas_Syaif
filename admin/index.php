<?php
  ...
  }else if($include=="konfirmasi-tambah-mitra"){
    include("include/konfirmasitambahmitra.php");
  }else if($include=="konfirmasi-edit-mitra"){
    include("include/konfirmasieditmitra.php");
  }
  }
?>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
      <div class="wrapper">
        ...
        <div class="content-wrapper">
          ...
          }else if($include=="mitra"){
            include("include/mitra.php");
          }else if($include=="tambah-mitra"){
            include("include/tambahmitra.php");
          }else if($include=="edit-mitra"){
            include("include/editmitra.php");
          }else if($include=="detail-mitra"){
            include("include/detailmitra.php");
