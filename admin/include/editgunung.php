...
if (isset($_GET['data'])) {
  ...
  $sql_d = "SELECT `id_gunung`,`foto_gunung`,`nama_gunung`,`desc_singkat`,`desc`,`letak_geografis`,`ketinggian`,`sop`,`harga_simaksi`,`id_provinsi` from `gunung` where `id_gunung` = '$id_gunung'";
  $query_d = mysqli_query($koneksi, $sql_d);
  while ($data_d = mysqli_fetch_row($query_d)) {
    $id_gunung = $data_d[0];
    $foto_gunung = $data_d[1];
    $nama_gunung = $data_d[2];
    $desc_singkat = $data_d[3];
    $desc = $data_d[4];
    $letak_geografis = $data_d[5];
    $ketinggian = $data_d[6];
    $sop = $data_d[7];
    $harga_simaksi = $data_d[8];
    $id_provinsi = $data_d[9];
}
}
?>
...
<section class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h3><i class="fas fa-edit"></i> Edit gunung</h3>
      </div>
      <div class="col-sm-6">
...
<section class="content">
  ...
  <div class="card card-success">
    ...
    <form class="form-horizontal" action="index.php?include=konfirmasi-edit-gunung" method="post" enctype="multipart/form-data">
      <div class="card-body">

      <div class="form-group row">
            <label for="foto_gunung" class="col-sm-3 col-form-label">foto gunung </label>
            <div class="col-sm-7">
              <div class="custom-file">
                <input type="file" class="custom-file-input" name="foto_gunung" id="customFile" value="foto_gunung<?php echo $foto_gunung ?>">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-7">
              <div class="custom-file">
                <input type="file" class="custom-file-input" name="sop" id="customFile" value="sop/<?php echo $sop ?>">
                <label class="custom-file-label" for="customFile">Choose file</label>
              </div>  
            </div>
          </div>
        ...
        <div class="form-group row">
      <label for="id_provinsi" class="col-sm-3 col-form-
