...
?>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 class="text-primer"><i class="fas fa-edit text-primer"></i> Edit Profil</h3>
          </div>
          <div class="col-sm-6">
    ...
    <div class="card card-i">
      <div class="card-header bg-success">
        ...
        <div class="card-tools">
          <a href="index.php?include=profil" class="btn btn-sm bg-primer float-right text-white"><i class="fas fa-arrow-alt-circle-left"></i> Kembali</a>
        </div>
      </div>
      <!-- /.card-header -->
      <!-- form start -->
      ...
      <form class="form-horizontal" action="index.php?include=konfirmasi-edit-profil" method="post" enctype="multipart/form-data">
        ...
        <div class="card-footer">
          <div class="col-sm-12">
            <button type="submit" class="btn btn-success float-right text-white"><i class="fas fa-save"></i> Simpan</button>
          </div>  
        </div>
        <!-- /.card-footer -->
      </form>
