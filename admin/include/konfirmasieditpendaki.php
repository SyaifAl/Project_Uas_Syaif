...
if(isset($_SESSION['id_pendaki'])){
    ...
    //     &jenis=tgllahir");
	    ...
	    $sql = "UPDATE `pendaki` set `nama_pendaki`='$nama_pendaki',`nik`='$nik', `jenis_kelamin`='$jenis_kelamin',`alamat`='$alamat', `email`='$email', `telpon`='$telpon', `telpon_keluarga`='$telpon_keluarga', `id_booking`='$id_booking' WHERE `id_pendaki`='$id_pendaki'";
