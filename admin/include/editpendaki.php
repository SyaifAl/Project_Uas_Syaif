...
if (isset($_GET['data'])) {
  ...
  $sql_d = "SELECT `nama_pendaki`,`nik`,`jenis_kelamin`,`alamat`,`email`,`telpon`,`telpon_keluarga`,`id_booking` from `pendaki` where `id_pendaki` = '$id_pendaki'";
