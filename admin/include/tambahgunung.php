    ...
    <section class="content">
        ...
        <div class="card card-success">
            ...
            <form class="form-horizontal" method="post" action="index.php?include=konfirmasi-tambah-gunung" enctype="multipart/form-data">
                <div class="card-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-7">
                            <textarea  id="editor2" class="form-control"  value="" name="Deskripsi"></textarea>
                        </div>
                    </div>
                    <div class="form-group row">
