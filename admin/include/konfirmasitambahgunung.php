...
// include('../koneksi/koneksi.php');
    ...
    if(empty($nama_gunung)){
	    header("Location:index.php?include=tambah-gunung&data=&notif=tambahkosong&jenis=nama_gunung");
	...
	$sql = "INSERT INTO `gunung` (`nama_gunung`, `desc_singkat`, `desc`, `letak_geografis`, `ketinggian`, `sop`, `harga_simaksi`, `id_provinsi`, `foto_gunung`)
